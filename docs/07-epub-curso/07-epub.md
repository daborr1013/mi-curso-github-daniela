## Annexes et ressources imprimables

Le cours complet et les exercices sont disponibles en formats EPUB et PDF, générés avec Pandoc.

Ce format permet :
- une lecture sur mobile et tablette  
- une consultation hors ligne  
- une organisation structurée du contenu  
- un accès aux exercices imprimables du cours
